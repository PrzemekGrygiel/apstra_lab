...
virsh destroy leaf5-re   
virsh destroy leaf5-pfe    
virsh destroy leaf6-re   
virsh destroy leaf6-pfe  
...
virsh undefine leaf5-re    
virsh undefine leaf5-pfe   
virsh undefine leaf6-re    
virsh undefine leaf6-pfe   
...
ifconfig leaf5-int down
ifconfig leaf6-int down
...
ifconfig leaf5-3 down
ifconfig leaf5-0 down
ifconfig leaf5-1 down
ifconfig leaf5-2 down
ifconfig leaf5-3 down
ifconfig leaf6-0 down
ifconfig leaf6-1 down
ifconfig leaf6-2 down
ifconfig leaf6-3 down
ifconfig s1-l1 down
ifconfig s1-l2 down
ifconfig s1-l3 down
ifconfig s1-l4 down
...
rm -rf /var/lib/libvirt/images/leaf5-re.qcow2
rm -rf /var/lib/libvirt/images/leaf5-pfe.qcow2
rm -rf /var/lib/libvirt/images/leaf6-re.qcow2
rm -rf /var/lib/libvirt/images/leaf6-pfe.qcow2
...
brctl addbr leaf5-int
brctl addbr leaf6-int
brctl addbr leaf1-0
brctl addbr leaf1-1
brctl addbr leaf1-2
brctl addbr leaf1-3
...
ifconfig leaf5-int up
ifconfig leaf6-int up
ifconfig leaf1-0 up
ifconfig leaf1-1 up
ifconfig leaf1-2 up
ifconfig leaf1-3 up
...
echo 16384 > /sys/class/net/s1-l5/bridge/group_fwd_mask
echo 16384 > /sys/class/net/s1-l6/bridge/group_fwd_mask
...
echo 16384 > /sys/class/net/s2-l5/bridge/group_fwd_mask
echo 16384 > /sys/class/net/s2-l6/bridge/group_fwd_mask
...
cp -fn $VQFX_RE /var/lib/libvirt/images/leaf5-re.qcow2
cp -fn $VQFX_PFE /var/lib/libvirt/images/leaf5-pfe.qcow2
cp -fn $VQFX_RE /var/lib/libvirt/images/leaf6-re.qcow2
cp -fn $VQFX_PFE /var/lib/libvirt/images/leaf6-pfe.qcow2
...
virt-install \
    ...
    --vcpus=2 \
    --import \
    --disk /var/lib/libvirt/images/leaf5-re.qcow2,bus=ide,format=qcow2 \
    --network bridge=mgmt,model=e1000 \
    --network bridge=leaf4-int,model=e1000 \
    --network bridge=mgmt,model=e1000 \
    --network bridge=s1-l4,model=e1000 \
...
virt-install \
    ...
    --vcpus=2 \
    --import \
    --disk /var/lib/libvirt/images/leaf5-pfe.qcow2,bus=ide,format=qcow2 \
    --network bridge=mgmt,model=e1000 \
    --network bridge=leaf4-int,model=e1000 \
    --noautoconsole
...
virt-install \
    ...
    --vcpus=2 \
    --import \
    --disk /var/lib/libvirt/images/leaf6-re.qcow2,bus=ide,format=qcow2 \
    --network bridge=mgmt,model=e1000 \
    --network bridge=leaf4-int,model=e1000 \
    --network bridge=mgmt,model=e1000 \
    --network bridge=s1-l4,model=e1000 \
...
virt-install \
    ...
    --vcpus=2 \
    --import \
    --disk /var/lib/libvirt/images/leaf6-pfe.qcow2,bus=ide,format=qcow2 \
    --network bridge=mgmt,model=e1000 \
    --network bridge=leaf4-int,model=e1000 \
    --noautoconsole
